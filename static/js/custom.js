$(document).ready(function() {
    ...
    /*edited starts here*/
    $('#notsent').on('click', function() {
        //using custom CSS
        // .ajs-message.ajs-custom { color: #31708f;  background-color: #d9edf7;  border-color: #31708f; }
        alertify.set('notifier','position', 'top-center');
        alertify.notify('Still In Development.', 'custom', 2, function(){console.log('dismissed');}).dismissOthers();
    });
    ...
    $('.alertify_nofify_top').on('click', function() {
        ...
        // .ajs-message.ajs-custom { color: #31708f;  background-color: #d9edf7;  border-color: #31708f; }
        alertify.set('notifier','position', 'top-center');
        alertify.notify('Site In Development.', 'custom', 2, function(){console.log('dismissed');}).dismissOthers();
    });
    ...
    $('#alertify_success_top').on('click', function() {
        ...
        // .ajs-message.ajs-custom { color: #31708f;  background-color: #d9edf7;  border-color: #31708f; }
        alertify.set('notifier','position', 'top-center');
        alertify.notify('Liked.', 'custom', 2, function(){console.log('dismissed');}).dismissOthers();
    });
    /*edited ends here*/
